...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.contactList = QListWidget(self.verticalLayoutWidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.addContactButton.setText(
            QCoreApplication.translate("MainWindow", u"Add Contact", None))
        self.viewContactButton.setText(
            QCoreApplication.translate("MainWindow", u"View Contact", None))
        self.deleteContactButton.setText(
            QCoreApplication.translate("MainWindow", u"Delete Contact", None))
    # retranslateUi
